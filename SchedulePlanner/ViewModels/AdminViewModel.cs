...
public class AdminViewModel : ReactiveObject
{
    ...
    [Reactive] 
    public ObservableCollection<string> Breadcrumb { get; private set; } = new();
    [Reactive]
    public bool IsUserAddingAvail { get; private set; }
    ...
    private void OnStudentAdding(Group group)
    {
        ModalWindow.Open(new StudentAddingView(group),$"Adding students to {group.Name}");
    }
    ...
    public AdminViewModel()
    {
        ...
        AddStudentCommand = ReactiveCommand.Create<Group>(OnStudentAdding);
